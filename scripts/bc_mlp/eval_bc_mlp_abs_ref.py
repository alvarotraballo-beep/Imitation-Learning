#!/usr/bin/env python3
"""Evaluate the robust absolute-reference BC-MLP in MuJoCo."""
...
from train_bc_mlp_abs_ref import AbsRefBCMLP  # noqa: E402
    ...
    for step in range(args.horizon):
        ...
        if step % args.print_every == 0 or step == args.horizon - 1:
            print(
                ...
                f"q_target={np.round(q_target, 3)} bad_table_contacts={bad_contacts}"
            )
...
def main():
    ...
    parser.add_argument("--checkpoint", default="bc_mlp_policy_experiment/robust_v2/models/bc_mlp_abs_ref_robust_128eps.pt")
    ...
    print("robust abs-ref bc_mlp successes:", successes, "/", len(results))
